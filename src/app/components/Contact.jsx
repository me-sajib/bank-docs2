					...
					<div className="space-y-8">
						...
						<div className="space-y-4">
							...
							<div className="flex items-center">
								...
								<span className="ml-3 text-black">info@bmhzorg.nl</span>
							</div>
							<div className="flex items-center">
								<Clock className="h-6 w-6 text-blue-600" />
								<span className="ml-3 text-black">Maandag tot en met vrijdag, van 9:00 tot 17:00 uur</span>
							</div>
						</div>
					</div>
					<div className="bg-white p-8 rounded-lg shadow-md">
						<form className="space-y-6">
							<div>
								...
								<input
									type="text"
									className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 text-black focus:border-transparent"
									placeholder="Uw naam"
								/>
							</div>
							<div>
